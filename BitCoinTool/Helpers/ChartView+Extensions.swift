...
extension LineChartView {
    ...
    func setData(dataPoints: [Int], values: [Double], label: String, lineColor: UIColor? = .black, drawCirclesEnabled: Bool = false, drawValuesEnabled: Bool = false) {
        ...
        chartDataSet.colors = [lineColor ?? .customWhitecolor]
        
        chartDataSet.highlightLineDashLengths = [5.0, 2.5]
        chartDataSet.highlightColor = UIColor.customGreenColor
        chartDataSet.highlightLineWidth = 1.0
        
        let gradientColors = [UIColor.customGreenColor.cgColor, UIColor.clear.cgColor] as CFArray // Colors of the gradient
